...
## Getting Started
### Install
Download and include locally, or via [CDN](https://cdn.jsdelivr.net/gh/ffd8/xyscopejs/xyscope.js):  
`<script src="https://cdn.jsdelivr.net/gh/ffd8/xyscopejs/xyscope.js"></script>` 

For live-coding in [P5LIVE](https://p5live.org), include it in the libs array:  
`let libs = ['https://cdn.jsdelivr.net/gh/ffd8/xyscopejs/xyscope.js']`
